...
var Topics = {
  science: {
    ...
    settings: {
      modelType: "gpt-3.5-turbo" /* Default */,
      maxTokens: 1e3,
      temperature: 0.5,
      topP: 1,
      presencePenalty: 0,
...
var MentorModel = class {
  constructor(id, mentor, apiKey, preferredLanguage, suffix) {
...
var commands = {
  ...
  enhance: {
    ...
    prompt: {
      ...
      fr: {
        role: "system",
        content: "Je vais te donner un texte et tu vas l'am\xE9liorer. Tu vas corriger les fautes d'orthographe, grammaire et syntaxe. En utilisant des mots et phrases avec un meilleur niveau de fran\xE7ais, tu vas rendre mes phrases plus belles et \xE9l\xE9gantes. Pr\xE9serve le sens exact du texte. Chaque changement que tu fais doit respecter le style original du texte. Le texte est en Markdown, indique tous tes changements en gras. Quand je dois retravailler le contenu s\xE9mantique d'une phrase du texte original, mets-la en italique. Ne r\xE9pond qu'avec le texte am\xE9lior\xE9. N'explique tes changements que si et seulement si je te le demande."
      }
    },
    pattern: [
...
var ChatView = class extends import_obsidian2.ItemView {
  constructor(leaf, token, preferredMentorId, preferredLanguage) {
    super(leaf);
